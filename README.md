...
### 📊 個股策略回測
- 🎯 **三大策略**: 布林通道策略、突破策略、日內交易策略 (CPR + Camarilla)
- 📈 **股價走勢圖**: 清晰的價格圖表和技術指標疊加
- 💰 **投資組合追蹤**: 實時計算策略表現和報酬率
- 📋 **交易記錄**: 詳細的買賣點記錄和分析
- 🔄 **策略比較**: 與買入持有策略的表現對比
- 🎛️ **參數調整**: 靈活的策略參數自訂功能
- 💾 **本地數據**: 使用632支股票的本地TWSE數據庫

### 🎯 批量回測系統
- 📊 **多股票同時回測**: 支援全市場或自選股票清單批量回測
- 🔄 **多策略比較**: 同時測試布林通道、突破策略、日內交易策略
- 🎛️ **智能篩選**: 自動篩選出表現優異的股票 (可設定最低報酬率)
- 📈 **進度監控**: 即時顯示回測進度和成功/失敗統計
- 💾 **結果自動保存**: CSV格式自動保存，便於後續分析
- 📋 **即時下載**: 支援優質股票清單和完整結果即時下載

### 📋 批量回測結果查看
- 📁 **歷史結果管理**: 查看所有歷史批量回測結果文件
- 🌐 **在線/離線結果**: 支援在線和離線回測結果分類查看
- 📊 **多策略比較**: 策略表現比較分析和統計
- 📈 **數據視覺化**: 報酬率分布圖、勝率分析等互動圖表
- 📥 **結果下載**: 支援歷史文件下載和即時結果匯出
...
#### 主頁面導航
- 🔍 **股票篩選工具**: 智能篩選界面，支援多維度財務指標篩選
- 📊 **個股策略回測**: 單一股票策略分析工具，支援三大交易策略
- 🎯 **批量回測**: 多股票批量回測系統，支援全市場分析
- 📋 **批量回測結果**: 歷史批量回測結果查看和管理
- 📈 **投資組合分析**: 投資組合管理和分析工具
